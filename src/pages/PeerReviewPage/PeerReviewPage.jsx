...
const PeerReviewPage = () => {
  ...
  const handleScoreChange = (criteriaId, value) => {
    ...
    // CHANGE: Use parseFloat to allow decimals
  ...
  const rawTotalScore = useMemo(() => {
    const total = Object.values(scores).reduce((acc, score) => acc + (score || 0), 0);
    // Format to avoid long decimals like 5.0000001
    ...
    try {
      ...
      if (response.statusCode === 200 || response.statusCode === 400) {
        ...
        if (response.statusCode === 400) {
            toast.warn(response.message || "The assignment does not meet the requirements.");
        } else {
  ...
  if (isLoading)
    return (
      <div className="p-8 text-center text-xl">Finding Assignment...</div>
    );
  if (error)
        ...
        <div className="space-y-8">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-bold text-gray-900 text-lg">
                    Assignment -{" "}
                    {reviewData.studentName ?? "Unknown user"}
                  </p>
                  ...
                  >
                    ...
                    <div className="col-span-5">
                      {isGeneratingAi ? (
                        ...
                        <div>
                          ...
                          <p
                            className={`text-sm ${
                              ...
                              aiFeedbackForItem.summary.includes("Unable to evaluate")
                        ...
                        <div className="text-center text-gray-900">
                          <Zap size={24} className="mx-auto mb-1 text-gray-700" />
                    ...
                    <div className="col-span-2 flex items-center justify-center">
                      <input
                        ...
                        step="0.25" // CHANGE: Allow decimals with 0.25 step
                        value={
          ...
          {aiSummaryData && (
            <div className="bg-white p-6 rounded-lg border animate-fade-in">
              ...
              <div className={`p-4 rounded-lg border ${aiSummaryData.statusCode === 400 ? 'bg-red-50 border-red-200' : 'bg-blue-50 border-blue-200'}`}>
                ...
                <p className={`mt-2 ${aiSummaryData.statusCode === 400 ? 'text-red-700' : 'text-gray-700'}`}>
