...
const CourseCard = ({ title, code, teacher, students, campus }) => (
  <div className="bg-white p-6 rounded-lg shadow-sm w-full">
    ...
    <div className="space-y-2 text-sm text-gray-600">
      <p className="flex items-center"><User className="w-4 h-4 mr-2" /> Instructor: {teacher}</p>
      <p className="flex items-center"><User className="w-4 h-4 mr-2" /> {students} Students</p>
