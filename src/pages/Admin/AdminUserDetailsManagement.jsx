            ...
            {editing ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <InfoCard
                  icon={<School />}
                  label="Campus"
                  value={campuses.find(c => c.campusId === user.campusId)?.campusName || "N/A"}
                />
                <InfoCard
                  icon={<BookOpen />}
                  label="Major"
                  value={majors.find(m => m.majorId === user.majorId)?.majorName || "N/A"}
                />
                ...
                {user.enrolledCourses?.map((course) => (
                  <div key={course.courseInstanceId} className="border rounded-xl p-4 bg-gray-50 hover:bg-gray-100 transition">
                    ...
                    <p><strong>Passed:</strong>{" "}
                      <span className={course.isPassed ? "text-green-600" : "text-red-600"}>
