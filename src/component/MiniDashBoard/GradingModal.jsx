...
import { X, Send, Download, Eye } from "lucide-react";
...
const GradingModal = ({
  ...
  const { data: detailResponse, isLoading } = useQuery({
    ...
    queryFn: () =>
      studentReviewService.getReviewAssignmentDetails(reviewAssignmentId),
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4 backdrop-blur-sm">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col animate-fade-in-up">
        <div className="flex justify-between items-center p-6 border-b bg-gray-50 rounded-t-xl">
          <div>
            <h2 className="text-xl font-bold text-gray-800">Quick Grading</h2>
            {reviewData && (
              ...
              <div className="bg-blue-50 p-4 rounded-lg flex justify-between items-center border border-blue-100">
                ...
                <div className="flex space-x-2">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="p-2 bg-white text-blue-600 rounded shadow hover:bg-blue-50"
                  >
                    <Eye size={18} />
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        className="w-20 p-2 text-center border border-gray-300 rounded focus:ring-2 focus:ring-orange-500 focus:outline-none font-bold"
                        placeholder="0"
                      />
