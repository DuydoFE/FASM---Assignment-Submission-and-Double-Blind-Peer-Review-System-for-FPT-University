...
const IntructorManageGrading = () => {
  ...
  const maxScore = 10; // max score config
  ...
  const [students] = useState([
    {
      ...
      mssv: '2021001',
      score: 8.5,
      feedback: 'Good design, need to improve colors...',
    ...
    },
    {
      ...
      mssv: '2021003',
      score: 7.0,
      feedback: 'Quite good, need to improve typography...',
    ...
    },
    {
      ...
      mssv: '2021005',
      score: 5.5,
      feedback: 'Need major improvements on layout and color...',
  ...
  const handleStatusClick = () => {
    ...
    else if (statusFilter === 'not-submitted') setStatusFilter('late');
    else if (statusFilter === 'late') setStatusFilter('graded');
  ...
  const getStatusStyle = (status) => {
    switch (status) {
      ...
      case 'not-submitted': return 'bg-yellow-100 text-yellow-700';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <div>
            ...
            <div className="relative">
              <select className="w-full px-4 py-2.5 border border-gray-300 rounded-lg appearance-none bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                <option>WDU391 - UI/UX Design</option>
              </select>
              <ChevronDown className="absolute right-3 top-3 w-5 h-5 text-gray-400 pointer-events-none" />
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
          <div className="flex justify-between items-start mb-3">
            <div>
              ...
              <p className="text-gray-600">Create a wireframe for an e-commerce website</p>
            </div>
          ...
          <div className="flex gap-6">
            <div className="flex items-center gap-2">
              <span className="text-green-600 font-medium">✓ 28/35 submitted</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-yellow-600 font-medium">⭐ 15/28 graded</span>
            </div>
          </div>
        </div>
